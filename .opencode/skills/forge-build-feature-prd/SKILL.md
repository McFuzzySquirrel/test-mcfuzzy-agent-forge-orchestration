...
| Signal | Mode |
|---|---|
| `docs/product-vision.md` exists, no `.agent.md` files in `.opencode/agents/` | Greenfield |
| `.opencode/agents/` contains `.agent.md` files (beyond forge templates) | Post-project |
...
2. Review existing agent files in `.opencode/agents/` (`.agent.md` files) -domains, responsibilities, collaboration patterns.
