...
Always consult the project's PRD, Product Vision, or Feature PRD for requirements, phases, dependencies, and acceptance criteria. Review all agent files in `.opencode/agents/*.agent.md` to understand each specialist's expertise, collaboration needs, and ownership boundaries.
