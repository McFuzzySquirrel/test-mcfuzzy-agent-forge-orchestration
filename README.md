...
Tasker Mail was created end-to-end by the **Agent Forge** pipeline using the new **orchestration DAG** engine from [McFuzzySquirrel/agent-forge-local](https://github.com/McFuzzySquirrel/agent-forge-local) (the "mcffuzy-agent-forge" repo). The pipeline ran fully autonomously after a single pre-flight approval:
...
Demo/utility project built with the Agent Forge pipeline. No license specified.
